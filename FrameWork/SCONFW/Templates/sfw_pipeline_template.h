...
#include <FrameWork/SCONFW/Templates/sfw_geometry_shader_template.h>
...
public:
	...
	sfw_geometry_template_shader_base	geometry_shader;	// defined custom user geometry emulation shader class. Comment out if if not used.
...
printf("vertex_shader.color_out.size() != vertex_shader.gl_out.size()\n");
		...
		geometry_shader.test_projmatrix = vertex_shader.modelViewProjectionMatrix;
