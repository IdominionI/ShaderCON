...
//#include "oglfw_shader_format.h"
#include "oglfw_Shader_preprocessor.h"
...
// modified Shader class to link to ofShader class
//class shader_class : public ofShader {
class oglfw_shader_class  : public oglfw_shader_base_class {
public:
	//oglfw_shader_class() = default;
	oglfw_shader_class() {}
	~oglfw_shader_class() { delete_program(); }

	std::string get_compilation_log() {
		return compile_log;
	}
...
//printf("create_shader_program vshader id 4444 : %s \n ", error_log.c_str());
			program = shader_compile_successful;
		}
...
//std::cout << "create_shader_program :Vertex glsl file " << shader_program_format.glsl_vertex_shader_file_pathname << std::endl;
//std::cout << "create_shader_program :Geometry glsl file " << shader_program_format.glsl_geometry_shader_file_pathname << std::endl;
//std::cout << "create_shader_program :Fragment glsl file " << shader_program_format.glsl_fragment_shader_file_pathname << std::endl;
...
//std::cout << "create_shader_program vshader id 00000 :  \n";
...
//std::cout << "create_shader_program vshader id 111111 :  \n";
...
//std::cout << "create_shader_program vshader id 111111A :  \n";
		if (have_geometry_shader) {
...
//std::cout << "create_shader_program vshader id 111111B :  \n";
...
//printf("\n ==>> GlslProg loadShader 666666 : \n");
	...
	GLuint create_shader_program(const std::string& vertex_shader_file,
		...
		//program = glCreateProgram();
		checkAndCreateProgram();// ofShader code that replaces above commented out line
		shader_compile_successful = program;
		...
		if (have_geometry_shader) glAttachShader(program, gs);
...
// glUniformMatrix2fv 
	...
	GLuint compile_shader_type = 0;

private:
	//GLuint program_id; // ofShader uses program
