...
//afw_globalc::get_current_logger()->log(LogLevel::INFO, "create_glfw_window 00");
        ...
        if (!glfwInit()) {
            afw_globalc::get_current_logger()->log(LogLevel::CRITICAL, "Unable to initialize OpenGL GLFW! ");
            return nullptr;
        }
        ...
        if (!window_ptr) {
            glfwTerminate();
            afw_globalc::get_current_logger()->log(LogLevel::CRITICAL, "Unable to create GLFW openGL window!");
            return nullptr;
        }
        ...
        if (glewInit() == GLEW_OK)
        {
            ...
            afw_globalc::get_current_logger()->log(LogLevel::INFO, "GLEW initialized successfully");
        } else {
            //std::cout << "Unable to initialize GLEW" << std::endl;
            afw_globalc::get_current_logger()->log(LogLevel::CRITICAL, "Unable to initialize GLEW. Exiting application");
