...
//	MARK: - near future
//	static std::filesystem::path removeExt(const std::filesystem::path& filename);
	...
	/// \returns path + slash
//	MARK: - near future
//	static std::filesystem::path addTrailingSlash(const std::filesystem::path& path);
	...
	// MARK - near future
	// static std::filesystem::path getAbsolutePath(const std::filesystem::path& path, bool bRelativeToData = true);
...
//	MARK: - near future
//	static std::filesystem::path getEnclosingDirectory(const std::filesystem::path& filePath, bool bRelativeToData = true);
	...
	/// \returns joined path
//	MARK: - near future
//	static std::filesystem::path join(const std::filesystem::path& path1, const std::filesystem::path& path2);
...
//	static std::filesystem::path getCurrentExeDir();
	...
	//	MARK: - near future
//    static std::filesystem::path makeRelative(const std::filesystem::path & from, const std::filesystem::path & to);
...
//	bool open(std::filesystem::path & path, Mode mode=ReadOnly, bool binary=true);
...
//	MARK: - near future
//	std::filesystem::path getEnclosingDirectory() const;
...
//	std::filesystem::path getAbsolutePath() const;
	...
	std::size_t listDir(const std::filesystem::path& path);
