...
public:
	...
	static void window_resize_callback(GLFWwindow* window, int width, int height) {
		if (!window) {
			afw_globalc::get_current_logger()->log(LogLevel::ERROR, "Unable to perform GLFW window resize call back : Window not definde! ");
			return;
		}
	...
	static void window_refreah_callback(GLFWwindow* window) {
		if (!window) {
			afw_globalc::get_current_logger()->log(LogLevel::ERROR, "Unable to perform GLFW window refresh call back : Window not definde! ");
			return;
		}
	...
	static void window_focus_callback(GLFWwindow* window, int focused) {
		if (!window) {
			afw_globalc::get_current_logger()->log(LogLevel::ERROR, "Unable to perform GLFW window focus call back : Window not definde! ");
			return;
		}
